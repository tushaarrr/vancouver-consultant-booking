  ...
  return (
    <div className="min-h-screen bg-lightbg font-sans">
      ...
      <main className="w-full max-w-[1600px] mx-auto px-2 sm:px-6 lg:px-12">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-8">
            ...
            >
              {[
                ...
                <motion.span
                  key={index}
                  className="flex items-center gap-2 bg-white/80 border border-gold text-navy px-5 py-2 rounded-full shadow-lg font-semibold text-sm hover:shadow-xl transition-all duration-300"
        ...
        >
          <motion.div 
            className="bg-white/80 rounded-3xl shadow-2xl border border-gold max-w-3xl mx-auto p-10 backdrop-blur-md hover:shadow-3xl transition-all duration-500"
